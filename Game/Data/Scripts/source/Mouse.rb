...
module Mouse
  ...
  # ## 常量
  #--------------------------------------------------------------------------
  HWND           = Win32API.new("DLL/RG3rd","hWnd","v","l")
  MousePos       = Win32API.new("DLL/RG3rd","MousePos","p","i")
  MouseInClient  = Win32API.new("DLL/RG3rd","MouseInClient","v","i")
  MouseUp        = Win32API.new("DLL/RG3rd","MouseUp","i","i")
  MouseDown      = Win32API.new("DLL/RG3rd","MouseDown","i","i")
  MouseDblClk    = Win32API.new("DLL/RG3rd","MouseDblClk","i","i")
  MousePress     = Win32API.new("DLL/RG3rd","MousePress","i","i")
  MouseToggled   = Win32API.new("DLL/RG3rd","MouseToggled","i","i")
  MouseWheel     = Win32API.new("DLL/RG3rd","MouseWheel","v","i")
  MouseMove      = Win32API.new("DLL/RG3rd","MouseMove","v","i")
  MouseSetPos    = Win32API.new("DLL/RG3rd","MouseSetPos","ii","i")
  MouseSetCursor = Win32API.new("DLL/RG3rd","MouseSetCursor","p","i")
  MouseSysCursor = Win32API.new("DLL/RG3rd","MouseSysCursor","v","i")
  MouseClip      = Win32API.new("DLL/RG3rd","MouseClip","iiii","i")
  MouseRelease   = Win32API.new("DLL/RG3rd","MouseRelease","v","i")
  CallBackStart  = Win32API.new("DLL/RG3rd","Start","i","i")
  CallBackStop   = Win32API.new("DLL/RG3rd","Stop","v","i")
  #--------------------------------------------------------------------------
  # ## 运行
  #--------------------------------------------------------------------------
